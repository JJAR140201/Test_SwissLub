...
--
-- Host: 127.0.0.1    Database: test_swisslub
-- ------------------------------------------------------
...
CREATE TABLE `movimiento_detalle` (
  ...
  CONSTRAINT `FKqu4iv8vmju352or7esvdo5iym` FOREIGN KEY (`movimiento_id`) REFERENCES `movimiento` (`id`)
...
INSERT INTO `movimiento_detalle` VALUES (1,1000,'Tomastes ',1);
...
-- Dump completed on 2023-08-12 15:24:45
